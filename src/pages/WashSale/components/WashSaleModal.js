...
import { listWashSaleDetails } from '../../../services/WashSaleService';
import { Close as CloseIcon } from '@material-ui/icons';
import Table, { columnType } from 'components/Table/Table';

export default function WashSaleModal({
  onClose: handleClose,
  open: isOpen,
  value,
}) {
  ...
  useEffect(
    () => {
      async function init() {
        console.log(value);
        const data = await listWashSaleDetails(value);
        console.log(data);
