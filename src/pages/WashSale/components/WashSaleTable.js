...
import WashSaleModal from './WashSaleModal';
import { listWashSale } from '../../../services/WashSaleService';
...
export default function WashSaleTable({ params }) {
  ...
  const handleSearch = async () => {
    try {
      ...
      const data = await listWashSale(searchData);
      console.log(data);
      setRows(data.washSalesList);
      notifyInfo(data.washSalesList.length + ' search results.');
    } catch (error) {
      console.error(error);
