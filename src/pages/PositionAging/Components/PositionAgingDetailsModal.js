...
import { listPositionAgingDetail } from '../../../services/PositionAgingService';
...
export default function PositionAgingDetailsModal({
  ...
  useEffect(
    () => {
      async function init() {
        const data = await listPositionAgingDetail(value);
        setRows(data.positionAgingDetailsList);
      }
