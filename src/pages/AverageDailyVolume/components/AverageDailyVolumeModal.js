...
import { listAverageDailyVolumeDetails } from '../../../services/AverageDailyVolumeService';
import { Close as CloseIcon } from '@material-ui/icons';
import Table, { columnType } from 'components/Table/Table';

export default function AverageDailyVolumeModal({
  onClose: handleClose,
  open: isOpen,
  value,
}) {
  ...
  useEffect(
    () => {
      async function init() {
        console.log(value);
        const data = await listAverageDailyVolumeDetails(value);
        console.log(data);
