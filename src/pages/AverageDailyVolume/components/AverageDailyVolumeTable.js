...
import AverageDailyVolumeModal from './AverageDailyVolumeModal';
import { listAverageDailyVolume } from '../../../services/AverageDailyVolumeService';
...
export default function AverageDailyVolumeTable({ params }) {
  ...
  const handleSearch = async () => {
    try {
      ...
      const data = await listAverageDailyVolume(searchData);
      console.log(data);
      setRows(data.averageDailyVolumesList);
      notifyInfo(data.averageDailyVolumesList.length + ' search results.');
    } catch (error) {
      console.error(error);
        ...
        {showFilter ? (
          <div>
            ...
            <div className={classes.grdRow}>
              ...
              <div className={classes.grdCell1} style={{ marginRight: 30 }}>
                <InputLabel shrink>Executing Venue</InputLabel>
                <TextField
                  fullWidth
                  name="executingVenue"
