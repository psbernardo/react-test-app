...
import { listMerger } from '../../../services/ReorgAnnouncement';

import { getSystemDate } from '../../../services/ProfileService';

export default function MergerTable({ params, announcementType }) {
  /*=========================================================================================
  Component style
  ===========================================================================================*/
  ...
  const handleSearch = async () => {
    try {
      ...
      const data = await listMerger(searchData);
      console.log(data.mergersList);
      setRows(data.mergersList);
      notifyInfo(data.mergersList.length + ' search results.');
    } catch (error) {
      console.error(error);
