...
import { listSpinOff } from '../../../services/ReorgAnnouncement';
import { getSystemDate } from '../../../services/ProfileService';

export default function SpinOffTable({ params, announcementType }) {
  /*=========================================================================================
  Component style
  ===========================================================================================*/
  ...
  const handleSearch = async () => {
    try {
      ...
      console.log(data.spinOffsList);
      setRows(data.spinOffsList);
