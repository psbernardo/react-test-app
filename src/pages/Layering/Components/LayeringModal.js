...
import { detailsLayering } from '../../../services/LayeringService';
import { Close as CloseIcon } from '@material-ui/icons';
import Table, { columnType } from 'components/Table/Table';

export default function LayeringModal({
  onClose: handleClose,
  open: isOpen,
  value,
}) {
  ...
  useEffect(
    () => {
      async function init() {
        console.log(value);
        const data = await detailsLayering(value);
        console.log(data);
        setRows(data.layeringDetailsList);
      }
