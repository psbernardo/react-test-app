...
import MiniManipulationModal from './MiniManipulationModal';
import { listMiniManipulation } from '../../../services/MiniManipulationService';
...
export default function MiniManipulationTable({ params }) {
  ...
  const handleSearch = async () => {
    try {
      ...
      const data = await listMiniManipulation(searchData);
      console.log(data)
      setRows(data.miniManipulationsList);
      notifyInfo(data.miniManipulationsList.length + ' search results.');
    } catch (error) {
      console.error(error);
