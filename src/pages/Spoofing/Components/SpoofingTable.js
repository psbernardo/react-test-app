...
import { listSpoofing } from '../../../services/SpoofingService';
...
export default function SpoofingTable({ params }) {
  ...
  const columns = [
    ...
    {
      name: 'cancelGrossAmt',
      label: 'Cancel Gross Amount',
      type: columnType.amount,
    },
    {
      name: 'executionGrossAmt',
      label: 'Execution Gross Amount',
      type: columnType.amount,
    },
    {
      name: 'a-selectAll',
  ...
  const handleSearch = async () => {
    try {
      ...
      const data = await listSpoofing(searchData);
      console.log(data);
      setRows(data.spoofingsList);
      notifyInfo(data.spoofingsList.length + ' search results.');
    } catch (error) {
      console.error(error);
