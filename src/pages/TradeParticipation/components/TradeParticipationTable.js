...
import TradeParticipationModal from './TradeParticipationModal';
import { listTradeParticipation } from '../../../services/TradeParticipationService';
...
export default function TradeParticipationTable({ params }) {
  ...
  const columns = [
    ...
    {
      name: 'buyCorrespondent',
      label: 'Buy Correspondent',
    },
    {
      name: 'buyAccountNo',
      label: 'Buy Account No',
    },
    {
      name: 'buyTraderId',
      label: 'Buy Trader ID',
    ...
    {
      name: 'sellCorrespondent',
      label: 'Sell Correspondent',
    },
    {
      name: 'sellAccountNo',
      label: 'Sell Account No',
    },
    {
      name: 'sellTraderId',
      label: 'Sell Trader ID',
    },
    {
      name: 'sellCount',
      label: 'Sell Count',
  ...
  const handleSearch = async () => {
    try {
      ...
      const data = await listTradeParticipation(searchData);
      console.log(data);
      setRows(data.tradeParticipationsList);
      notifyInfo(data.tradeParticipationsList.length + ' search results.');
    } catch (error) {
      console.error(error);
