...
import { lazyloadExchangeCode } from '../../services/CommonService';

export default function SelectExchangeCode(props) {
  ...
  const getOptions = async (value) => {
    const { systemcodesList } = await lazyloadExchangeCode(value);
