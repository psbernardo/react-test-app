...
import { lazyAccountName } from '../../services/CommonService';

export default function SelectAccountName(props) {
  ...
  const getOptions = async (value) => {
    const { accountNamesList } = await lazyAccountName(
      props.correspondent,
      value,
      props.type
    );
    setOptions(accountNamesList);
  };
